...
- [x] **Checklist included in [README.md](http://readme.md/):** Include the project's checklist in the [README.md](http://readme.md/) file. Mark all implemented features to provide a clear overview of the project's completion status.
...
- [x] **UI Deployment link in [README.md](http://readme.md/)**: Place the link to the deployed UI at the top of the [README.md](http://readme.md/) file, alongside the calculated score.
